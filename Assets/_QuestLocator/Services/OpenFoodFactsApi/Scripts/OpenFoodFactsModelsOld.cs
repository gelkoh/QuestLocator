...
namespace QuickType
{
    ...
    {
        public override bool CanConvert(Type t) => t == typeof(Grade) || t == typeof(Grade?);
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            throw new Exception("Cannot unmarshal type Grade");
        }
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            var value = (Grade)untypedValue;
            if (value == Grade.D)
            {
                serializer.Serialize(writer, "d");
                return;
            }
            throw new Exception("Cannot marshal type Grade");
        }

        public static readonly GradeConverter Singleton = new GradeConverter();
    }
}
