...
namespace Oculus.Interaction
{
    ...
    /// </summary>
    public class UIThemeManagerLocal : MonoBehaviour
    {
        [SerializeField]
        ...
        public void ApplyTheme(int index)
        {
            ...
            {
                if (animator.CompareTag("NoThemeOverride")) continue;
                else if (animator.CompareTag("QDSUIPrimaryButton"))
                {
            ...
            foreach (var image in images)
            {
                ...
                if (selectedTheme.ThemeVersion == 2)
                {
                    ...
                    {
                        if (image.material != selectedTheme.backplateGradientMaterial)
                        {
